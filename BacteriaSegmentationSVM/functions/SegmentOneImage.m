...
green = medfilt2(readimage(imdsg,Ind)); %% median filter by Jiagui

GREEN{1} = green;
red = medfilt2(readimage(imdsr,Ind)); %% median filter by Jiagui

RED{1} = red;
blue = medfilt2(readimage(imdsb,Ind)); %% median filter by Jiagui
