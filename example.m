...
addpath(genpath('/home/lijiag/Programming/')); % add path of the StitchIt(https://github.com/BaselLaserMouse/StitchIt).
...
%   
% %% Segmentation for the entire dataset with SVM.
