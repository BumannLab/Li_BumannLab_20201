...
prefix = 'section_';
SampleAddress = 'Mix2_gfp';
ResultAddress = '/mnt/BumannDrive/Jiagui/Joep/20171220_test/';
...
parfor optical = 1:5
   ...
   salm( greenC < 300 | blueC > greenC * 0.95 | blueC < greenC * 0.5)  = 0; %|redC > greenC * 3
...
%         figure, imshow(imadjust(redIm),[])
      ...
      if area > 5
         ...
         elseif x>200 && y>200 && x<(info.Width-200) && y<(info.Height-300)  %% crop bigger
