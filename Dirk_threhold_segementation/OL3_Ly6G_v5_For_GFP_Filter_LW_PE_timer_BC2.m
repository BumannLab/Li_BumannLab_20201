...
prefix = 'section_';
SampleAddress = '20170704_timer_D5_M2_NoOxy_RedBC1';
...
%         figure, imshow(imadjust(redIm),[])
      ...
      if area > 5
         ...
         if go>0
             x_pos = x * 0.435;
             y_pos = y * 0.435;
             fprintf(fileID,'%10d %10d %10d %10.1f %10.1f %10.1f %4d %10.1f %10.1f %10.1f %10.1f %10.2f %10.1f %10.1f %10f \n', frame, optical, component, x_pos, y_pos, z_pos, area, MeanIntens_green( component), MeanIntens_red( component), MeanIntens_green( component), MeanIntens_blue( component), MajorAxisLength( component) ,MinorAxisLength( component), Eccentricity( component), RedVal(component));
