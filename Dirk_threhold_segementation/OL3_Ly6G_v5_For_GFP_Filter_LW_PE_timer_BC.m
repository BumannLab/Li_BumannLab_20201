...
%          PE (GC > 0.04*RC | RC < 50) = 0; %% remove yellow dots
           ...
           rgbImage = cat(3, RC,GC,BC);%% PE : remove yellow dots
...
%            PE (GC > 0.05*RC) = 0; %% remove yellow dots
         ...
         if go>0
             x_pos = x * 0.435;
             y_pos = y * 0.435;
             fprintf(fileID,'%10d %10d %10d %10.1f %10.1f %10.1f %4d %10.1f %10.1f %10.1f %10.1f %10.2f %10.1f %10.1f %10f\n', frame, optical, component, x_pos, y_pos, z_pos, area, MeanIntens_green( component), MeanIntens_red( component), MeanIntens_green( component), MeanIntens_blue( component), MajorAxisLength( component) ,MinorAxisLength( component), Eccentricity( component), MeanIntens_redB( component));
