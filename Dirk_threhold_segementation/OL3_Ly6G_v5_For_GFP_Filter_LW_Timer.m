...
prefix = 'section_';
SampleAddress = '20171023_timer_D5_M2_NoOxy2';
...
for frame = 5:10
 ...
 parfor optical = 1:5
    ...
    salm( greenC <350 | blueC > greenC * 0.95 | blueC < greenC * 0.5 )  = 0; 
    ...
    for component=1:cc.NumObjects
      ...
      if area > 5
         ...
         if x>800 && y>800 && x<(info.Width-800) && y<(info.Height-800)  %% crop bigger
           ...
           RC( 1, 1) = 3200; GC( 1, 1) = 1600; BC( 1,1) = 1200;
           ...
           for i = -10: 10
              for j = -10: 10
                 ...
                 if g > 12000 ||  r > 14000  %%To decide whether to write into the txt file. if with filter, g should > 8000
                    go = 0;
                 end
              end
           end
