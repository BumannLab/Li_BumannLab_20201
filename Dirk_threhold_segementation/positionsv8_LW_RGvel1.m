...
for frame = 1:100
   ...
   for optical = 1:5
     ...
     formatSpec = '%d %d %d %f %f %f %d %f %f %f %f %f %f %f %f %f %f';  %% '%10d %10d %10d %10.1f %10.1f %10.1f %4d %10.1f %10.1f %10.1f %10.1f %10.2f %10.2f\n'
     sizeA = [17 Inf];
     if exist(fileName, 'file')
       ...
       A = A';
       fclose(fileID);
       number = number / 17;  %% count how many salm
...
for i = 1:salmonella
    if flag( i) < 1
       ...
       GreenVal( number) = GreenVal( i);
       BlueVal( number) = BlueVal( i);
    end
end
...
salmonella = number;
 ...
 for i = 1:salmonella
     fprintf(fileID,'%10d %10d %10d %10.1f %10.1f %10.1f %10.1f %10.1f %10.1f %10d %10.1f %10.1f %10.1f %10.1f %10.1f %10.1f %10.1f\n', Frame(i), Optical(i), Component(i), x(i), y(i), z(i), area(i), salm(i), Redmean(i), Greenmean(i), Bluemean(i), MajorAxisLength(i), MinorAxisLength(i), Eccentricity(i),  RedVal( i), GreenVal( i), BlueVal( i));
 end
