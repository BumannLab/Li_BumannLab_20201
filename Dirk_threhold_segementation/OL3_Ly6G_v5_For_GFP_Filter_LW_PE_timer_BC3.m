...
prefix = 'section_';
SampleAddress = '20170704_highTimer_4ABX_M1_RedBC3';
ResultAddress = 'G:/Jiagui/01_ABX_project/20171204_distribusion_GfpYfp/';
...
for optical = 1:2
    ...
    imwrite(strcat(ResultAddress,SampleAddress,'/SalmTextPic/',counter, '_', section, '-', no,'.tif'));
