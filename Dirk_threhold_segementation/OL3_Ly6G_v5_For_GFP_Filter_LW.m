...
prefix = 'section_';
SampleAddress = '20170615_highTimer_4ABX_GFPfil2';
...
for frame = 1:56
 ...
 parfor optical = 1:5
    ...
    salm( greenC <400 | blueC > greenC * 0.95 | blueC < greenC * 0.5 |red > 4000 |redC > greenC * 3)  = 0; 
         ...
         if x>800 && y>800 && x<(info.Width-800) && y<(info.Height-800)  %% crop bigger
           ...
           for i = -10: 10
              for j = -10: 10
                 ...
                 if g > 13000 ||  r > 6000  %%To decide whether to write into the txt file. if with filter, g should > 8000
                    go = 0;
                 end
              end
           end
